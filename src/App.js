...
function App() {
  ...
  useEffect(()=>{
    ...
    let img1 = document.getElementById("imgdiv");
    let popmov = document.getElementById("popular");
    let notf = document.getElementById("notfound");
